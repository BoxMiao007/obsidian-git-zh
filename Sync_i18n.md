...
-   新增功能的业务逻辑、类型和默认值可以直接修改 `src/**/*.ts`
-   新增功能的设置名称/描述等 UI 文案仍应保持英文，中文翻译统一添加到 `scripts/apply-translations.mjs`
-   避免在 `src/**/*.ts` 中直接硬编码中文文案，否则上游同步时更容易产生冲突
...
_本手册用于指导 AI 自动化执行 Obsidian Git 中文版的同步与汉化流程_
